...
//                }
                ...
                if ("http://profiles.catalyst.harvard.edu/ontology/prns#mentoringOverview".Equals(hf.Value) || "http://profiles.catalyst.harvard.edu/ontology/prns#hasMentoringJobOpportunity".Equals(hf.Value) || "http://profiles.catalyst.harvard.edu/ontology/plugins#FeaturedPresentations".Equals(hf.Value))
