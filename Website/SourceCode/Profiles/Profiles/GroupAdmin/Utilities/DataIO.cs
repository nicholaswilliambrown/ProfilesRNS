...
namespace Profiles.GroupAdmin.Utilities
{
    public class DataIO : Profiles.Framework.Utilities.DataIO
    {
        ...
        public void AddGroup(string groupName, Int64 visibility, string endDate)
        {
        ...
        public void UpdateGroup(int groupID, string groupName, Int64 visibility, string endDate)
        {
            SessionManagement sm = new SessionManagement();
