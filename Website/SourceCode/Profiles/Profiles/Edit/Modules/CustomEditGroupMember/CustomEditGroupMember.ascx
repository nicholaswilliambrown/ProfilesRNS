...
<br />
<br />
    <asp:UpdatePanel ID="pnlGridViewMembers" runat="server">
    <ContentTemplate>
    ...
    <asp:UpdatePanel ID="pnlGridViewManagers" runat="server">
    <ContentTemplate>
    ...
    <asp:UpdatePanel ID="pnlProxySearchResults" runat="server" Visible="false">
    <ContentTemplate>
            <asp:GridView EnableViewState="true" Width="100%" ID="gridSearchResults" runat="server" DataKeyNames="UserID"
                ...
                <Columns>
                    ...
                    <ItemTemplate>
                        <asp:CheckBox ID="chkPubMed" runat="server" />
                                ...
                                CausesValidation="False" OnClick="gvSearchResults_RowAdd" Text="Add"/></asp:Button>
            </ContentTemplate>
