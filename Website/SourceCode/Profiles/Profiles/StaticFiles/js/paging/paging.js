...
Paging.prototype.emitPrevNext = function(columnTarget, searchResults) {
    ...
    let first = $(`<span id="first">
                    <img class="link-ish prevNext" src="../img/paging/arrow_first.gif">
                    <img class="disablePageNav prevNext" src="../img/paging/arrow_first_d.gif">
                </span>`);
    let last =  $(`<span id="last">
                    <img class="ms-2 link-ish prevNext" src="../img/paging/arrow_last.gif">
                    <img class="ms-2 disablePageNav prevNext" src="../img/paging/arrow_last_d.gif">
                </span>`);
    let prev =  $(`<span id="prev">
                    <img class="ms-2 link-ish prevNext" src="../img/paging/arrow_prev.gif">
                    <img class="ms-2 disablePageNav prevNext" src="../img/paging/arrow_prev_d.gif">
                </span>`);
    let next =  $(`<span id="next">
                    <img class="ms-2 link-ish prevNext" src="../img/paging/arrow_next.gif">
                    <img class="ms-2 disablePageNav prevNext" src="../img/paging/arrow_next_d.gif">
                </span>`);
