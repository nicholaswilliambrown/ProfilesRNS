CREATE INDEX idx_Log_Activity_MethodPropertyPrivacy ON [Framework.].[Log.Activity] (methodName, Property, PrivacyCode);

alter table [Profile.Cache].[Person] add [NodeID]                  BIGINT           NULL
alter table [Profile.Cache].[Person] add [PreferredPath]           VARCHAR (MAX)    NULL
alter table [Profile.Cache].[Person] add [defaultApplication]      VARCHAR (MAX)    NULL

alter table [Profile.Data].[Publication.Group.MyPub.General] add [DOI]              VARCHAR (100)   NULL
alter table [Profile.Data].[Publication.MyPub.General] add [DOI]              VARCHAR (100)   NULL


alter table [Profile.Data].[Publication.PubMed.Author] add [EqualContrib]   VARCHAR (1)     NULL
alter table [Profile.Data].[Publication.PubMed.Author] add [FirstAuthor]    BIT             NULL
alter table [Profile.Data].[Publication.PubMed.Author] add [LastAuthor]     BIT             NULL

alter table [Profile.Data].[Publication.Pubmed.DisambiguationSettings] add [PubMedSearchTerm]        VARCHAR (MAX) NULL
alter table [Profile.Data].[Publication.Pubmed.DisambiguationSettings] add [PubMedSearchTermEnabled] BIT           NULL
alter table [Profile.Data].[Publication.Pubmed.DisambiguationSettings] add [ORCID]                   VARCHAR (MAX) NULL
alter table [Profile.Data].[Publication.Pubmed.DisambiguationSettings] add [SyncFromORCID]           BIT           NULL

alter table [Profile.Module].[GenericRDF.Plugins] add [_PropertyNode]          BIGINT        NULL
alter table [Profile.Module].[GenericRDF.Plugins] add [dataType]               BIT           NULL
...
--ALTER USER [App_HCProfiles] WITH LOGIN = [App_HCProfiles]
--[HCProfilesOpenSource_Localhost]